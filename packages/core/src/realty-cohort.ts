...
assertDataFile(dataFile as any, "realty/cohort.json");


export const REALTY_COHORT_LINKS = (dataFile as any).exports.REALTY_COHORT_LINKS;

/** 2025 인구주택총조사(등록센서스) 연령대 비중 %. 50대가 최빈. */
export const REALTY_AGE_SHARES = (dataFile as any).exports.REALTY_AGE_SHARES as readonly {
  id: string;
  label: string;
  share: number;
  family?: boolean;
...
export const REALTY_CENSUS_2025 = (dataFile as any).exports.REALTY_CENSUS_2025;

export const REALTY_MARRY_2025 = (dataFile as any).exports.REALTY_MARRY_2025;

export const REALTY_BIRTH_AGE = (dataFile as any).exports.REALTY_BIRTH_AGE;

export const REALTY_HOUSING_COHORT = (dataFile as any).exports.REALTY_HOUSING_COHORT;

export const REALTY_COHORT_SLOTS = (dataFile as any).exports.REALTY_COHORT_SLOTS;
