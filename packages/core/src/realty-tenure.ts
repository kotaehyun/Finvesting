...
assertDataFile(dataFile as any, "realty/tenure.json");


export const REALTY_TENURE_LINKS = (dataFile as any).exports.REALTY_TENURE_LINKS as any;

/** 국토부 2024 주거실태조사. 임차=전세+월세(보증부 포함). 전세만의 전국 칸은 원문 표. */
export const REALTY_TENURE = (dataFile as any).exports.REALTY_TENURE as any;

/** 국토부 2026년 7월 주택통계. 1–7월 누계 전월세 거래 중 월세(보증부·반전세 포함). */
export const REALTY_LEASE_TRADE = (dataFile as any).exports.REALTY_LEASE_TRADE as any;
