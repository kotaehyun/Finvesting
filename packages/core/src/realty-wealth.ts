...
assertDataFile(dataFile as any, "realty/wealth.json");
...
export const REALTY_WEALTH_LINKS = (dataFile as any).exports.REALTY_WEALTH_LINKS as any;

export const REALTY_WEALTH_PRIVACY = (dataFile as any).exports.REALTY_WEALTH_PRIVACY as any;

/** 2025 가계금융복지조사. 3월 말. 10분위 평균 순자산은 보도가 원문 표를 인용. */
export const REALTY_WEALTH_SHARE = (dataFile as any).exports.REALTY_WEALTH_SHARE as any;

export const REALTY_WEALTH_GIFT = (dataFile as any).exports.REALTY_WEALTH_GIFT as any;

/** 전업 부동산신탁사. 개인 명의신탁·연예인 은닉이 아님. */
export const REALTY_WEALTH_TRUST = (dataFile as any).exports.REALTY_WEALTH_TRUST as any;

export const REALTY_WEALTH_METHODS: readonly RealtyWealthMethod[] = (dataFile as any).exports.REALTY_WEALTH_METHODS as any;
