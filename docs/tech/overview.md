...
- 투자 대시보드 `/invest` (주요 지수·비트코인, 원자재, 환율, 기업 검색에서 관심 추가, 보유·관심, 히트맵. 시장·부동산으로 연결)
- 시장 `/markets` (인플레이션·BIS 금리 칸, 거래량 히트맵, 수급 원문 링크, 크립토·외환 히트맵·뉴스, 기술분석, 기업 검색)
- 부동산 `/realty` (전국 시군구 3D 도면. 선택 시 그 광역시도 예금은행 가계대출. 한은 가중평균·COFIX 금리 표. 점유 임차·전월세 거래 월세 비중, 카드 연체·리볼빙. 공실(자가·무상 제외)·빈집 유형·PIR·지니, 상환·경매신청·부동산업 연체·상가 수익률, 상위 10% 순자산·증여·상속·신탁 채널(실명 없음), 법인 종부세 창구, 고위공직 공개분. 4급 등록·연예인·임원 실명 없음. 떠도는 말 vs 공식에 총조사 연령·혼인·신혼 팩트. 유형별 매물 칸. 한경 부동산 뉴스. 데이터 업데이트는 뉴스·대출 재조회)
- 종목 재무제표·감사의견 `/statements` (DART/EDGAR 숫자 + 의견. 기업정보·OpenDART·「재무제표를 읽는 사람들」은 링크만. 본문 X. 로컬 LLM 읽어주기)
- Yahoo Fundamentals 표 `/fundamentals` (영문 칸. 시총·PER·PBR·ROE·배당 등 일 단위 스냅샷. 재무제표와 별도)
