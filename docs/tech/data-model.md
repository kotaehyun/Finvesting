...
| `insurance_policies` | 민영 보험 증권. 상품명·보험사·종류·월보험료·사망/암/뇌/심장/상해/후유장해 가입액·실손 여부. 4대보험과 별개. `/profile` 10 보험내역. 보장 분석은 `core/insurance-coverage.ts` (육각·칠각). AI 추천은 `insurance.recommend` (상품명 금지) |
